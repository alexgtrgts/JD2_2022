...
Необходимо посчитать для каждого студента затраченное время на изучение java в классе(вывести на экран тип студента,
 его талант, время необходимое для разбора, практики, нахождения в потоке и суммарное время на освоение навыка).
...
public class App {
    public static void main(String[] args) {
        Stream<Student> studentStream = Stream.of(new Student("Igor",0.1,new St1Strategy()),
                new Student("Anatoliy",0.2,new St1Strategy()),new Student("Boris",0.3,
                new St1Strategy()),new Student("Artem",0.4,new St2Strategy()),
                new Student("Vlad",0.5,new St2Strategy()), new Student("Petya",0.6,
                new St2Strategy()), new Student("Vasya",0.7,new St3Strategy()),new Student("Sergey",
                0.8,new St3Strategy()),new Student("Aleks",0.9,new St3Strategy()));
                studentStream.forEach(Student::executeCalculating);
    }
}
